                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
                          ...
                          <div key={m._id} className="match-card" style={{ padding: '12px 16px' }}>
                            <div style={{ display: 'flex', alignItems: 'center', gap: 16 }}>
                              <div style={{ flex: 1, textAlign: 'right', fontWeight: 700, fontSize: 14, maxWidth: 100, overflow: 'hidden', display: '-webkit-box', WebkitLineClamp: 2, WebkitBoxOrient: 'vertical', lineHeight: '1.2', minHeight: '2.4em' }}>{m.homeTeam?.name || '—'}</div>
