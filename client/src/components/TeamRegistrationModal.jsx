...
import { X, Save, Plus, Users, Shield, Phone, User } from 'lucide-react';
...
export default function TeamRegistrationModal({ tournament, onClose }) {
  ...
  const handleSubmit = async () => {
    ...
    setLoading(true);
    try {
      await api.post(`/tournaments/${tournament._id}/teams/public-register`, form);
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
          ...
          <div className="form-group">
            ...
            <div style={{ display: 'flex', gap: 8, marginBottom: 12 }}>
              <input className="form-input" placeholder="Nome do jogador..." value={playerName} onChange={e => setPlayerName(e.target.value)} onKeyDown={e => e.key === 'Enter' && addPlayer()} />
